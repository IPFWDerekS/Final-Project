...
Partial Class frmViewInventory
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Water Bottle Count:"
        '
        'Label2
        '
        ...
        Me.Label4.Text = "10K Medal Count:"
        '
        'Label5
        '
        ...
        Me.Label6.Text = "Small Shirt Count:"
        '
        'Label7
        '
